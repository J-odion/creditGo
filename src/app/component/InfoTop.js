...
export default function InfoTop() {
  ...
  return (
    ...
    >
      <div id="about-us" className="lg:w-[1376px] mx-auto">
        <FlowThree
          tag={"About Us"}
          btn={" Get started"}
      ...
      <div
        id="benefits"
        className=" lg:w-[1376px] lg:h-[586px] rounded-[36px] flex justify-center mx-auto py-[44px] px-[14px] lg:px-[58px] lg:bg-[url('/assets/MobileImpact.png')] md:bg-[url('/assets/OurBenefit.png')] bg-[#122023]"
      >
        <div className="flex flex-col justify-between   ">
          <div className="flex justify-center text-center flex-col">
